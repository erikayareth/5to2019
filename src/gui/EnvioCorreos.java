...
public class EnvioCorreos extends javax.swing.JFrame {
    ...
    boolean sendMail(){
        Meiltools meiltools = new Meiltools();
        String recipient = jTextField2.getText();
        String subject = jTextField1.getText();
        String content = jTextArea1.getText();
        boolean result = meiltools.sendMail(meiltools.logInSession(
        "erikayareth.btcg.programacion@gmail.com","pedroymario09"), recipient, subject, content);
        return result;
    }
